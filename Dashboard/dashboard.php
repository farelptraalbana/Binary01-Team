      ...
      <div class="container-fluid">
        ...
        <div class="input-group mb-3 mt-3" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
          <form action="" method="post" class="mx-auto w-50" >
            ...
            <button type="submit" name="submit" class="btn mt-4 d-block mx-auto" style="background-color: #FFBA08; border-radius: 40px; width: 100px;"><a href="../Dashboard/lacak_kiriman.php">Search</a></button>
          </form>
        </div>
      </div>     
    </div>
