                     ...
                     <div class="modal-content">
                        ...
                        <form method="POST" action="action_CRUD.php">
                           ...
                           <div class="mb-3">
                              ...
                              <input type="text" class="form-control" name="tkurir" 
                              value="<?=$data['nama_kurir']?>" placeholder="Masukkan Nama Kurir">
                           </div>
                           <div class="mb-3">
                              <label class="form-label">Nomor Telepon</label>
                              <input type="text" class="form-control" name="tnomor" 
                              value="<?=$data['no_kurir']?>" placeholder="Masukkan Nomor Telepon">
                           </div>
                           <div class="mb-3">
                              <label class="form-label">Plat Kendaraan</label>
                              <input type="text" class="form-control" name="tplat" 
                              value="<?=$data['plat_nomor']?>" placeholder="Masukkan Plat Kendaraan">
                           </div>
                        </div>
