                  ...
                  <form method="POST" action="action_CRUD.php">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="tresi" value="<?= $data['no_resi'] ?>" placeholder="Masukkan No Resi Barang">
                      </div>
                      <div class="mb-3">
                        <label class="form-label">Nama Pengirim</label>
                        <input type="text" class="form-control" name="tpengirim" value="<?= $data['nama_pengirim'] ?>" placeholder="Masukkan Nama Pengirim">
                      </div>
                      <div class="mb-3">
                        <label class="form-label">Nama Penerima</label>
                        <input type="text" class="form-control" name="tpenerima" value="<?= $data['nama_penerima'] ?>" placeholder="Masukkan Nama Penerima">
                      </div>
                      <div class="mb-3">
                        <label class="form-label">Asal Kiriman</label>
                        <input type="text" class="form-control" name="tasal" value="<?= $data['asal_kiriman'] ?>" placeholder="Masukkan Kota Asal Kiriman">
                      </div>
                      <div class="mb-3">
                        <label class="form-label">Tujuan Kiriman</label>
                        <input type="text" class="form-control" name="ttujuan" value="<?= $data['tujuan_barang'] ?>" placeholder="Masukkan Kota Tujuan Kiriman">
                      </div>
                      <div class="mb-3">
                        <label class="form-label">Waktu Kiriman</label>
                        <input type="text" class="form-control" name="twaktu" value="<?= $data['waktu_pengiriman'] ?>" placeholder="Masukkan Waktu Kiriman">
                      </div>
                      <div class="mb-3">
                        <label class="form-label">Biaya Kiriman</label>
                        <input type="text" class="form-control" name="tbiaya" value="<?= $data['biaya'] ?>" placeholder="Masukkan Biaya Kiriman">
                      </div>
                    </div>
              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <form method="POST" action="action_CRUD.php">
                    ...
                    <div class="modal-footer">
                      <button type="submit" class="btn btn-warning w-50 text-dark" name="bhapus">Hapus aja bang Admin</button>
                      <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Tutup</button>
                    </div>
                  </form>
                </div>
